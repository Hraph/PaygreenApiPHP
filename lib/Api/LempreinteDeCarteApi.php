...
/**
 * LempreinteDeCarteApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
...
class LempreinteDeCarteApi
{
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintGet
     *
    ...
    {
        list($response) = $this->apiIdentifiantPayinsCardprintGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayinsCardprintGetWithHttpInfo
     *
     * Liste des empreintes de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintGetAsync
     *
     * Liste des empreintes de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPayinsCardprintGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantPayinsCardprintGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintGetAsyncWithHttpInfo
     *
     * Liste des empreintes de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsCardprintGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    public function apiIdentifiantPayinsCardprintGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsCardprintGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsCardprintGet'
            );
        }

        $resourcePath = '/api/{identifiant}/payins/cardprint';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintIdDelete
     *
     * Supprimer une empreinte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id Api.Model.CardPrint.id (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function apiIdentifiantPayinsCardprintIdDelete($identifiant, $authorization, $id)
    {
        $this->apiIdentifiantPayinsCardprintIdDeleteWithHttpInfo($identifiant, $authorization, $id);
    }

    /**
     * Operation apiIdentifiantPayinsCardprintIdDeleteWithHttpInfo
     *
     * Supprimer une empreinte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPayinsCardprintIdDeleteWithHttpInfo($identifiant, $authorization, $id)
    {
        $request = $this->apiIdentifiantPayinsCardprintIdDeleteRequest($identifiant, $authorization, $id);
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintIdDeleteAsync
     *
     * Supprimer une empreinte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayinsCardprintIdDeleteAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantPayinsCardprintIdDeleteAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintIdDeleteAsyncWithHttpInfo
     *
     * Supprimer une empreinte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayinsCardprintIdDeleteAsyncWithHttpInfo($identifiant, $authorization, $id)
    {
        $returnType = '';
        $request = $this->apiIdentifiantPayinsCardprintIdDeleteRequest($identifiant, $authorization, $id);
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsCardprintIdDelete'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id Api.Model.CardPrint.id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantPayinsCardprintIdDeleteRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsCardprintIdDelete'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsCardprintIdDelete'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantPayinsCardprintIdDelete'
            );
        }

        $resourcePath = '/api/{identifiant}/payins/cardprint/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintIdGet
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    {
        list($response) = $this->apiIdentifiantPayinsCardprintIdGetWithHttpInfo($identifiant, $authorization, $id);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayinsCardprintIdGetWithHttpInfo
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintIdGetAsync
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayinsCardprintIdGetAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantPayinsCardprintIdGetAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintIdGetAsyncWithHttpInfo
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsCardprintIdGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id Api.Model.CardPrint.id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantPayinsCardprintIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsCardprintIdGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsCardprintIdGet'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantPayinsCardprintIdGet'
            );
        }
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintPost
     *
     * Création d&#39;une empreinte de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\CardPrint $card_print Modèle d&#39;une empreinte de carte. (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse20014
    ...
    {
        list($response) = $this->apiIdentifiantPayinsCardprintPostWithHttpInfo($identifiant, $authorization, $card_print);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayinsCardprintPostWithHttpInfo
     *
     * Création d&#39;une empreinte de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintPostAsync
     *
     * Création d&#39;une empreinte de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayinsCardprintPostAsync($identifiant, $authorization, $card_print)
    {
        return $this->apiIdentifiantPayinsCardprintPostAsyncWithHttpInfo($identifiant, $authorization, $card_print)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsCardprintPostAsyncWithHttpInfo
     *
     * Création d&#39;une empreinte de carte
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsCardprintPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\CardPrint $card_print Modèle d&#39;une empreinte de carte. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantPayinsCardprintPostRequest($identifiant, $authorization, $card_print)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsCardprintPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsCardprintPost'
            );
        }
        // verify the required parameter 'card_print' is set
        if ($card_print === null || (is_array($card_print) && count($card_print) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $card_print when calling apiIdentifiantPayinsCardprintPost'
            );
        }
        ...
        if (isset($card_print)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($card_print));
            } else {
                $httpBody = $card_print;
            }
