...
/**
 * LesMoyensDePaiementApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
...
class LesMoyensDePaiementApi
{
    ...
    /**
     * Operation apiIdentifiantPaymenttypeGet
     *
     ...
     */
    public function apiIdentifiantPaymenttypeGet($identifiant, $authorization)
    {
        list($response) = $this->apiIdentifiantPaymenttypeGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantPaymenttypeGetWithHttpInfo
     *
     * Liste des moyens de paiement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPaymenttypeGetWithHttpInfo($identifiant, $authorization)
    {
        $request = $this->apiIdentifiantPaymenttypeGetRequest($identifiant, $authorization);
    ...
    /**
     * Operation apiIdentifiantPaymenttypeGetAsync
     *
     * Liste des moyens de paiement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPaymenttypeGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantPaymenttypeGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPaymenttypeGetAsyncWithHttpInfo
     *
     * Liste des moyens de paiement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPaymenttypeGetAsyncWithHttpInfo($identifiant, $authorization)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse2007';
        $request = $this->apiIdentifiantPaymenttypeGetRequest($identifiant, $authorization);
    ...
    /**
     * Create request for operation 'apiIdentifiantPaymenttypeGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantPaymenttypeGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPaymenttypeGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPaymenttypeGet'
            );
        }

        $resourcePath = '/api/{identifiant}/paymenttype';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
