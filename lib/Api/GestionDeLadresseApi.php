...
/**
 * GestionDeLadresseApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
...
class GestionDeLadresseApi
{
    ...
    /**
     * Operation apiIdentifiantAddressGet
     *
     * Liste des adresses
     *
    ...
    {
        list($response) = $this->apiIdentifiantAddressGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantAddressGetWithHttpInfo
     *
     * Liste des adresses
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantAddressGetAsync
     *
     * Liste des adresses
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantAddressGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantAddressGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantAddressGetAsyncWithHttpInfo
     *
     * Liste des adresses
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantAddressGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantAddressGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantAddressGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantAddressGet'
            );
        }

        $resourcePath = '/api/{identifiant}/address';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantAddressPost
     *
     * Créer une adresse
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Address $address Modèle d&#39;une adresse (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse2004
    ...
    {
        list($response) = $this->apiIdentifiantAddressPostWithHttpInfo($identifiant, $authorization, $address);
        return $response;
    }

    /**
     * Operation apiIdentifiantAddressPostWithHttpInfo
     *
     * Créer une adresse
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantAddressPostAsync
     *
     * Créer une adresse
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantAddressPostAsync($identifiant, $authorization, $address)
    {
        return $this->apiIdentifiantAddressPostAsyncWithHttpInfo($identifiant, $authorization, $address)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantAddressPostAsyncWithHttpInfo
     *
     * Créer une adresse
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantAddressPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Address $address Modèle d&#39;une adresse (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantAddressPostRequest($identifiant, $authorization, $address)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantAddressPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantAddressPost'
            );
        }
        // verify the required parameter 'address' is set
        if ($address === null || (is_array($address) && count($address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $address when calling apiIdentifiantAddressPost'
            );
        }
