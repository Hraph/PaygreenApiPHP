...
class GestionDeLadresseApi
{
     ...
     */
    public function apiIdentifiantAddressGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantAddressPostRequest($identifiant, $authorization, $address)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
