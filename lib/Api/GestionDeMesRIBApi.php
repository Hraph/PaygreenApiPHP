...
class GestionDeMesRIBApi
{
     ...
     */
    protected function apiIdentifiantBankGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantBankPostRequest($identifiant, $authorization, $rib)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
