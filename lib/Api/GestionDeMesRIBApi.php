...
/**
 * GestionDeMesRIBApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
...
class GestionDeMesRIBApi
{
    ...
    /**
     * Operation apiIdentifiantBankGet
     *
     * Afficher mon RIB
     *
     ...
     * @return \Hraph\PaygreenApi\Model\InlineResponse20018
     */
    public function apiIdentifiantBankGet($identifiant, $authorization)
    {
        list($response) = $this->apiIdentifiantBankGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantBankGetWithHttpInfo
     *
     * Afficher mon RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Hraph\PaygreenApi\Model\InlineResponse20018, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiIdentifiantBankGetWithHttpInfo($identifiant, $authorization)
    {
        $request = $this->apiIdentifiantBankGetRequest($identifiant, $authorization);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Hraph\PaygreenApi\Model\InlineResponse20018' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Hraph\PaygreenApi\Model\InlineResponse20018', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20018';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Hraph\PaygreenApi\Model\InlineResponse20018',
    ...
    /**
     * Operation apiIdentifiantBankGetAsync
     *
     * Afficher mon RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantBankGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantBankGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantBankGetAsyncWithHttpInfo
     *
     * Afficher mon RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantBankGetAsyncWithHttpInfo($identifiant, $authorization)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20018';
        $request = $this->apiIdentifiantBankGetRequest($identifiant, $authorization);
    ...
    /**
     * Create request for operation 'apiIdentifiantBankGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    public function apiIdentifiantBankGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantBankGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantBankGet'
            );
        }

        $resourcePath = '/api/{identifiant}/bank';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantBankPost
     *
     * Création d&#39;un RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Rib $rib Modèle de données d&#39;un RIB (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse20019
     */
    public function apiIdentifiantBankPost($identifiant, $authorization, $rib)
    {
        list($response) = $this->apiIdentifiantBankPostWithHttpInfo($identifiant, $authorization, $rib);
        return $response;
    }

    /**
     * Operation apiIdentifiantBankPostWithHttpInfo
     *
     * Création d&#39;un RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Hraph\PaygreenApi\Model\InlineResponse20019, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiIdentifiantBankPostWithHttpInfo($identifiant, $authorization, $rib)
    {
        $request = $this->apiIdentifiantBankPostRequest($identifiant, $authorization, $rib);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Hraph\PaygreenApi\Model\InlineResponse20019' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Hraph\PaygreenApi\Model\InlineResponse20019', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20019';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Hraph\PaygreenApi\Model\InlineResponse20019',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation apiIdentifiantBankPostAsync
     *
     * Création d&#39;un RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantBankPostAsync($identifiant, $authorization, $rib)
    {
        return $this->apiIdentifiantBankPostAsyncWithHttpInfo($identifiant, $authorization, $rib)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantBankPostAsyncWithHttpInfo
     *
     * Création d&#39;un RIB
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantBankPostAsyncWithHttpInfo($identifiant, $authorization, $rib)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20019';
        $request = $this->apiIdentifiantBankPostRequest($identifiant, $authorization, $rib);
    ...
    /**
     * Create request for operation 'apiIdentifiantBankPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Rib $rib Modèle de données d&#39;un RIB (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantBankPostRequest($identifiant, $authorization, $rib)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantBankPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantBankPost'
            );
        }
        // verify the required parameter 'rib' is set
        if ($rib === null || (is_array($rib) && count($rib) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $rib when calling apiIdentifiantBankPost'
            );
        }
        ...
        if (isset($rib)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($rib));
            } else {
                $httpBody = $rib;
            }
