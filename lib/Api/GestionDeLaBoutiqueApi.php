...
class GestionDeLaBoutiqueApi
{
     ...
     */
    public function apiIdentifiantShopGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantShopPatchRequest($identifiant, $authorization, $shop_patch)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($shop_patch)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($shop_patch));
            } else {
                $httpBody = $shop_patch;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantShopPostRequest($identifiant, $authorization, $shop)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if (isset($shop)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($shop));
            } else {
                $httpBody = $shop;
            }
        } elseif (count($formParams) > 0) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantShopPutRequest($identifiant, $authorization, $shop)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantShopShopIdGetRequest($identifiant, $authorization, $shop_id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantShopShopIdPutRequest($identifiant, $authorization, $shop_id, $shop)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
