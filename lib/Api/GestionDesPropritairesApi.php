...
class GestionDesPropritairesApi
{
     ...
     */
    protected function apiIdentifiantShareholderGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantShareholderPostRequest($identifiant, $authorization, $shareholder)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
