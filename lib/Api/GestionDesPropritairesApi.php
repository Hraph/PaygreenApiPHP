...
/**
 * GestionDesPropritairesApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GestionDesPropritairesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation apiIdentifiantShareholderGet
     *
    ...
    {
        list($response) = $this->apiIdentifiantShareholderGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantShareholderGetWithHttpInfo
     *
     * Liste des propriétaires
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantShareholderGetAsync
     *
     * Liste des propriétaires
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantShareholderGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantShareholderGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantShareholderGetAsyncWithHttpInfo
     *
     * Liste des propriétaires
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantShareholderGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    public function apiIdentifiantShareholderGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantShareholderGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantShareholderGet'
            );
        }

        $resourcePath = '/api/{identifiant}/shareholder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantShareholderPost
     *
     * Créer un propriétaire
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Shareholder $shareholder Modèle d&#39;un propriétaire (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->apiIdentifiantShareholderPostWithHttpInfo($identifiant, $authorization, $shareholder);
        return $response;
    }

    /**
     * Operation apiIdentifiantShareholderPostWithHttpInfo
     *
     * Créer un propriétaire
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantShareholderPostAsync
     *
     * Créer un propriétaire
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantShareholderPostAsync($identifiant, $authorization, $shareholder)
    {
        return $this->apiIdentifiantShareholderPostAsyncWithHttpInfo($identifiant, $authorization, $shareholder)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantShareholderPostAsyncWithHttpInfo
     *
     * Créer un propriétaire
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantShareholderPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Shareholder $shareholder Modèle d&#39;un propriétaire (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantShareholderPostRequest($identifiant, $authorization, $shareholder)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantShareholderPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantShareholderPost'
            );
        }
        // verify the required parameter 'shareholder' is set
        if ($shareholder === null || (is_array($shareholder) && count($shareholder) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $shareholder when calling apiIdentifiantShareholderPost'
            );
        }
        ...
        if (isset($shareholder)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($shareholder));
            } else {
                $httpBody = $shareholder;
            }
