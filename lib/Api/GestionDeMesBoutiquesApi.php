...
/**
 * GestionDeMesBoutiquesApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GestionDeMesBoutiquesApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation apiIdentifiantShopsGet
     *
     * Liste des boutiques
     *
     ...
     */
    public function apiIdentifiantShopsGet($identifiant, $authorization)
    {
        list($response) = $this->apiIdentifiantShopsGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantShopsGetWithHttpInfo
     *
     * Liste des boutiques
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantShopsGetWithHttpInfo($identifiant, $authorization)
    {
        $request = $this->apiIdentifiantShopsGetRequest($identifiant, $authorization);
    ...
    /**
     * Operation apiIdentifiantShopsGetAsync
     *
     * Liste des boutiques
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantShopsGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantShopsGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantShopsGetAsyncWithHttpInfo
     *
     * Liste des boutiques
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantShopsGetAsyncWithHttpInfo($identifiant, $authorization)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse2002';
        $request = $this->apiIdentifiantShopsGetRequest($identifiant, $authorization);
    ...
    /**
     * Create request for operation 'apiIdentifiantShopsGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantShopsGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantShopsGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantShopsGet'
            );
        }

        $resourcePath = '/api/{identifiant}/shops';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
