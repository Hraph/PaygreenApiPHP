...
class GestionDuComptePrincipalApi
{
     ...
     */
    public function apiIdentifiantAccountGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantAccountPutRequest($identifiant, $authorization, $account)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
