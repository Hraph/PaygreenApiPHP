...
/**
 * GestionDuComptePrincipalApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GestionDuComptePrincipalApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation apiIdentifiantAccountGet
     *
    ...
    {
        list($response) = $this->apiIdentifiantAccountGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantAccountGetWithHttpInfo
     *
     * Afficher le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantAccountGetAsync
     *
     * Afficher le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantAccountGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantAccountGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantAccountGetAsyncWithHttpInfo
     *
     * Afficher le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantAccountGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantAccountGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantAccountGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantAccountGet'
            );
        }

        $resourcePath = '/api/{identifiant}/account';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantAccountPut
     *
     * Met à jour le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Account $account Modèle de données du compte principal PayGreen (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse2003
    ...
    {
        list($response) = $this->apiIdentifiantAccountPutWithHttpInfo($identifiant, $authorization, $account);
        return $response;
    }

    /**
     * Operation apiIdentifiantAccountPutWithHttpInfo
     *
     * Met à jour le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantAccountPutAsync
     *
     * Met à jour le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantAccountPutAsync($identifiant, $authorization, $account)
    {
        return $this->apiIdentifiantAccountPutAsyncWithHttpInfo($identifiant, $authorization, $account)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantAccountPutAsyncWithHttpInfo
     *
     * Met à jour le compte principal
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantAccountPut'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Account $account Modèle de données du compte principal PayGreen (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantAccountPutRequest($identifiant, $authorization, $account)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantAccountPut'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantAccountPut'
            );
        }
        // verify the required parameter 'account' is set
        if ($account === null || (is_array($account) && count($account) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account when calling apiIdentifiantAccountPut'
            );
        }
