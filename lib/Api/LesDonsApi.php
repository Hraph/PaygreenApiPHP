...
class LesDonsApi
{
    ...
    /**
     * Operation apiIdentifiantSolidarityIdDelete
     *
     * Supprimer un don
     *
     ...
     * @param  string $id ID du don (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function apiIdentifiantSolidarityIdDelete($identifiant, $authorization, $id)
    {
        $this->apiIdentifiantSolidarityIdDeleteWithHttpInfo($identifiant, $authorization, $id);
    }

    /**
     * Operation apiIdentifiantSolidarityIdDeleteWithHttpInfo
     *
     * Supprimer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantSolidarityIdDeleteWithHttpInfo($identifiant, $authorization, $id)
    {
        $request = $this->apiIdentifiantSolidarityIdDeleteRequest($identifiant, $authorization, $id);
    ...
    /**
     * Operation apiIdentifiantSolidarityIdDeleteAsync
     *
     * Supprimer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantSolidarityIdDeleteAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantSolidarityIdDeleteAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantSolidarityIdDeleteAsyncWithHttpInfo
     *
     * Supprimer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantSolidarityIdDeleteAsyncWithHttpInfo($identifiant, $authorization, $id)
    {
        $returnType = '';
        $request = $this->apiIdentifiantSolidarityIdDeleteRequest($identifiant, $authorization, $id);
    ...
    /**
     * Create request for operation 'apiIdentifiantSolidarityIdDelete'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID du don (required)
     ...
     */
    public function apiIdentifiantSolidarityIdDeleteRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantSolidarityIdDelete'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantSolidarityIdDelete'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantSolidarityIdDelete'
            );
        }

        $resourcePath = '/api/{identifiant}/solidarity/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantSolidarityIdGet
     *
     * Afficher un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    {
        list($response) = $this->apiIdentifiantSolidarityIdGetWithHttpInfo($identifiant, $authorization, $id);
        return $response;
    }

    /**
     * Operation apiIdentifiantSolidarityIdGetWithHttpInfo
     *
     * Afficher un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantSolidarityIdGetAsync
     *
     * Afficher un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantSolidarityIdGetAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantSolidarityIdGetAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantSolidarityIdGetAsyncWithHttpInfo
     *
     * Afficher un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantSolidarityIdGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID du don (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantSolidarityIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantSolidarityIdGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantSolidarityIdGet'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantSolidarityIdGet'
            );
        }
    ...
    /**
     * Operation apiIdentifiantSolidarityIdPatch
     *
     * Créer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @param  \Hraph\PaygreenApi\Model\Solidarity $solidarity Modèle de données d&#39;un don. (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse20016
    ...
    {
        list($response) = $this->apiIdentifiantSolidarityIdPatchWithHttpInfo($identifiant, $authorization, $id, $solidarity);
        return $response;
    }

    /**
     * Operation apiIdentifiantSolidarityIdPatchWithHttpInfo
     *
     * Créer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantSolidarityIdPatchAsync
     *
     * Créer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantSolidarityIdPatchAsync($identifiant, $authorization, $id, $solidarity)
    {
        return $this->apiIdentifiantSolidarityIdPatchAsyncWithHttpInfo($identifiant, $authorization, $id, $solidarity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantSolidarityIdPatchAsyncWithHttpInfo
     *
     * Créer un don
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantSolidarityIdPatch'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID de la transaction (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantSolidarityIdPatchRequest($identifiant, $authorization, $id, $solidarity)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantSolidarityIdPatch'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantSolidarityIdPatch'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantSolidarityIdPatch'
            );
        }
        // verify the required parameter 'solidarity' is set
        if ($solidarity === null || (is_array($solidarity) && count($solidarity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $solidarity when calling apiIdentifiantSolidarityIdPatch'
            );
        }
        ...
        if (isset($solidarity)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($solidarity));
            } else {
                $httpBody = $solidarity;
            }
