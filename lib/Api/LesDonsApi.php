...
class LesDonsApi
{
     ...
     */
    protected function apiIdentifiantSolidarityIdDeleteRequest($identifiant, $authorization, $id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantSolidarityIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantSolidarityIdPatchRequest($identifiant, $authorization, $id, $solidarity)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
