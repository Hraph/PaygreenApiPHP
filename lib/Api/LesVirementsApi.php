...
/**
 * LesVirementsApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
...
class LesVirementsApi
{
    ...
    /**
     * Operation apiIdentifiantPayoutTransferGet
     *
     * Liste des virements
     *
     ...
     * @return \Hraph\PaygreenApi\Model\InlineResponse20021
     */
    public function apiIdentifiantPayoutTransferGet($identifiant, $authorization)
    {
        list($response) = $this->apiIdentifiantPayoutTransferGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayoutTransferGetWithHttpInfo
     *
     * Liste des virements
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Hraph\PaygreenApi\Model\InlineResponse20021, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiIdentifiantPayoutTransferGetWithHttpInfo($identifiant, $authorization)
    {
        $request = $this->apiIdentifiantPayoutTransferGetRequest($identifiant, $authorization);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Hraph\PaygreenApi\Model\InlineResponse20021' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Hraph\PaygreenApi\Model\InlineResponse20021', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20021';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Hraph\PaygreenApi\Model\InlineResponse20021',
    ...
    /**
     * Operation apiIdentifiantPayoutTransferGetAsync
     *
     * Liste des virements
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPayoutTransferGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantPayoutTransferGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayoutTransferGetAsyncWithHttpInfo
     *
     * Liste des virements
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayoutTransferGetAsyncWithHttpInfo($identifiant, $authorization)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20021';
        $request = $this->apiIdentifiantPayoutTransferGetRequest($identifiant, $authorization);
    ...
    /**
     * Create request for operation 'apiIdentifiantPayoutTransferGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    public function apiIdentifiantPayoutTransferGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayoutTransferGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayoutTransferGet'
            );
        }

        $resourcePath = '/api/{identifiant}/payout/transfer';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantPayoutTransferIdGet
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id Api.Model.Transfer.id (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse20020
     */
    public function apiIdentifiantPayoutTransferIdGet($identifiant, $authorization, $id)
    {
        list($response) = $this->apiIdentifiantPayoutTransferIdGetWithHttpInfo($identifiant, $authorization, $id);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayoutTransferIdGetWithHttpInfo
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Hraph\PaygreenApi\Model\InlineResponse20020, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiIdentifiantPayoutTransferIdGetWithHttpInfo($identifiant, $authorization, $id)
    {
        $request = $this->apiIdentifiantPayoutTransferIdGetRequest($identifiant, $authorization, $id);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Hraph\PaygreenApi\Model\InlineResponse20020' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Hraph\PaygreenApi\Model\InlineResponse20020', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20020';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Hraph\PaygreenApi\Model\InlineResponse20020',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation apiIdentifiantPayoutTransferIdGetAsync
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayoutTransferIdGetAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantPayoutTransferIdGetAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayoutTransferIdGetAsyncWithHttpInfo
     *
     * Détails
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayoutTransferIdGetAsyncWithHttpInfo($identifiant, $authorization, $id)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20020';
        $request = $this->apiIdentifiantPayoutTransferIdGetRequest($identifiant, $authorization, $id);
    ...
    /**
     * Create request for operation 'apiIdentifiantPayoutTransferIdGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id Api.Model.Transfer.id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantPayoutTransferIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayoutTransferIdGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayoutTransferIdGet'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantPayoutTransferIdGet'
            );
        }

        $resourcePath = '/api/{identifiant}/payout/transfer/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantPayoutTransferPost
     *
     * Créer un virement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Transfer $transfer Modèle de données d&#39;un virement. (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse20020
     */
    public function apiIdentifiantPayoutTransferPost($identifiant, $authorization, $transfer)
    {
        list($response) = $this->apiIdentifiantPayoutTransferPostWithHttpInfo($identifiant, $authorization, $transfer);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayoutTransferPostWithHttpInfo
     *
     * Créer un virement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return array of \Hraph\PaygreenApi\Model\InlineResponse20020, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiIdentifiantPayoutTransferPostWithHttpInfo($identifiant, $authorization, $transfer)
    {
        $request = $this->apiIdentifiantPayoutTransferPostRequest($identifiant, $authorization, $transfer);
    ...
    /**
     * Operation apiIdentifiantPayoutTransferPostAsync
     *
     * Créer un virement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayoutTransferPostAsync($identifiant, $authorization, $transfer)
    {
        return $this->apiIdentifiantPayoutTransferPostAsyncWithHttpInfo($identifiant, $authorization, $transfer)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayoutTransferPostAsyncWithHttpInfo
     *
     * Créer un virement
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayoutTransferPostAsyncWithHttpInfo($identifiant, $authorization, $transfer)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20020';
        $request = $this->apiIdentifiantPayoutTransferPostRequest($identifiant, $authorization, $transfer);
    ...
    /**
     * Create request for operation 'apiIdentifiantPayoutTransferPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\Transfer $transfer Modèle de données d&#39;un virement. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantPayoutTransferPostRequest($identifiant, $authorization, $transfer)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayoutTransferPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayoutTransferPost'
            );
        }
        // verify the required parameter 'transfer' is set
        if ($transfer === null || (is_array($transfer) && count($transfer) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transfer when calling apiIdentifiantPayoutTransferPost'
            );
        }
        ...
        if (isset($transfer)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($transfer));
            } else {
                $httpBody = $transfer;
            }
