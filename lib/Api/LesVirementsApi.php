...
class LesVirementsApi
{
     ...
     */
    protected function apiIdentifiantPayoutTransferGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayoutTransferIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayoutTransferPostRequest($identifiant, $authorization, $transfer)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
