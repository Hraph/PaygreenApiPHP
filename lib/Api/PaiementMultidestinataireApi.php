...
/**
 * PaiementMultidestinataireApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PaiementMultidestinataireApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation apiIdentifiantPayinsMultiCashPost
     *
     ...
     * @param  \Hraph\PaygreenApi\Model\PayinsMulti $payins_multi Modèle d&#39;un paiement multidestinataires (required)
     *
    ...
    {
        list($response) = $this->apiIdentifiantPayinsMultiCashPostWithHttpInfo($identifiant, $authorization, $payins_multi);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayinsMultiCashPostWithHttpInfo
     *
     * Créer un paiement multidestinataires
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantPayinsMultiCashPostAsync
     *
     * Créer un paiement multidestinataires
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPayinsMultiCashPostAsync($identifiant, $authorization, $payins_multi)
    {
        return $this->apiIdentifiantPayinsMultiCashPostAsyncWithHttpInfo($identifiant, $authorization, $payins_multi)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsMultiCashPostAsyncWithHttpInfo
     *
     * Créer un paiement multidestinataires
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsMultiCashPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  \Hraph\PaygreenApi\Model\PayinsMulti $payins_multi Modèle d&#39;un paiement multidestinataires (required)
     ...
     */
    public function apiIdentifiantPayinsMultiCashPostRequest($identifiant, $authorization, $payins_multi)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsMultiCashPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsMultiCashPost'
            );
        }
        // verify the required parameter 'payins_multi' is set
        if ($payins_multi === null || (is_array($payins_multi) && count($payins_multi) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $payins_multi when calling apiIdentifiantPayinsMultiCashPost'
            );
        }

        $resourcePath = '/api/{identifiant}/payins/multi/cash';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($payins_multi)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($payins_multi));
            } else {
                $httpBody = $payins_multi;
            }
