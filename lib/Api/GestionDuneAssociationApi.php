...
/**
 * GestionDuneAssociationApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GestionDuneAssociationApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation apiIdentifiantSolidarityGet
     *
     ...
     * @return \Hraph\PaygreenApi\Model\InlineResponse20015
     */
    public function apiIdentifiantSolidarityGet($identifiant, $authorization)
    {
        list($response) = $this->apiIdentifiantSolidarityGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantSolidarityGetWithHttpInfo
     *
     * Liste des associations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Hraph\PaygreenApi\Model\InlineResponse20015, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiIdentifiantSolidarityGetWithHttpInfo($identifiant, $authorization)
    {
        $request = $this->apiIdentifiantSolidarityGetRequest($identifiant, $authorization);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Hraph\PaygreenApi\Model\InlineResponse20015' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Hraph\PaygreenApi\Model\InlineResponse20015', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20015';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Hraph\PaygreenApi\Model\InlineResponse20015',
    ...
    /**
     * Operation apiIdentifiantSolidarityGetAsync
     *
     * Liste des associations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantSolidarityGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantSolidarityGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantSolidarityGetAsyncWithHttpInfo
     *
     * Liste des associations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantSolidarityGetAsyncWithHttpInfo($identifiant, $authorization)
    {
        $returnType = '\Hraph\PaygreenApi\Model\InlineResponse20015';
        $request = $this->apiIdentifiantSolidarityGetRequest($identifiant, $authorization);
    ...
    /**
     * Create request for operation 'apiIdentifiantSolidarityGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantSolidarityGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantSolidarityGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantSolidarityGet'
            );
        }

        $resourcePath = '/api/{identifiant}/solidarity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
