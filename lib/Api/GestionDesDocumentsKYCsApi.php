...
/**
 * GestionDesDocumentsKYCsApi Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class GestionDesDocumentsKYCsApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation apiIdentifiantDocumentsGet
     *
     * Liste des documents
     *
    ...
    {
        list($response) = $this->apiIdentifiantDocumentsGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantDocumentsGetWithHttpInfo
     *
     * Liste des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantDocumentsGetAsync
     *
     * Liste des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantDocumentsGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantDocumentsGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantDocumentsGetAsyncWithHttpInfo
     *
     * Liste des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantDocumentsGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantDocumentsGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantDocumentsGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantDocumentsGet'
            );
        }

        $resourcePath = '/api/{identifiant}/documents';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantDocumentsIdDelete
     *
     * Supprimer un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID d&#39;un document (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function apiIdentifiantDocumentsIdDelete($identifiant, $authorization, $id)
    {
        $this->apiIdentifiantDocumentsIdDeleteWithHttpInfo($identifiant, $authorization, $id);
    }

    /**
     * Operation apiIdentifiantDocumentsIdDeleteWithHttpInfo
     *
     * Supprimer un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantDocumentsIdDeleteWithHttpInfo($identifiant, $authorization, $id)
    {
        $request = $this->apiIdentifiantDocumentsIdDeleteRequest($identifiant, $authorization, $id);
    ...
    /**
     * Operation apiIdentifiantDocumentsIdDeleteAsync
     *
     * Supprimer un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantDocumentsIdDeleteAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantDocumentsIdDeleteAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantDocumentsIdDeleteAsyncWithHttpInfo
     *
     * Supprimer un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantDocumentsIdDeleteAsyncWithHttpInfo($identifiant, $authorization, $id)
    {
        $returnType = '';
        $request = $this->apiIdentifiantDocumentsIdDeleteRequest($identifiant, $authorization, $id);
    ...
    /**
     * Create request for operation 'apiIdentifiantDocumentsIdDelete'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID d&#39;un document (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantDocumentsIdDeleteRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantDocumentsIdDelete'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantDocumentsIdDelete'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantDocumentsIdDelete'
            );
        }

        $resourcePath = '/api/{identifiant}/documents/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantDocumentsIdGet
     *
     * Obtenir un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    {
        list($response) = $this->apiIdentifiantDocumentsIdGetWithHttpInfo($identifiant, $authorization, $id);
        return $response;
    }

    /**
     * Operation apiIdentifiantDocumentsIdGetWithHttpInfo
     *
     * Obtenir un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantDocumentsIdGetAsync
     *
     * Obtenir un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantDocumentsIdGetAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantDocumentsIdGetAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantDocumentsIdGetAsyncWithHttpInfo
     *
     * Obtenir un document
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantDocumentsIdGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID d&#39;un document (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantDocumentsIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantDocumentsIdGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantDocumentsIdGet'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantDocumentsIdGet'
            );
        }
    ...
    /**
     * Operation apiIdentifiantDocumentsPost
     *
     * Envoyer des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $content_type multipart/form-data; boundary&#x3D;-------------------------acebdf13572 (required)
     *
     * @throws \Hraph\PaygreenApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Hraph\PaygreenApi\Model\InlineResponse20010
    ...
    {
        list($response) = $this->apiIdentifiantDocumentsPostWithHttpInfo($identifiant, $authorization, $content_type);
        return $response;
    }

    /**
     * Operation apiIdentifiantDocumentsPostWithHttpInfo
     *
     * Envoyer des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantDocumentsPostAsync
     *
     * Envoyer des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantDocumentsPostAsync($identifiant, $authorization, $content_type)
    {
        return $this->apiIdentifiantDocumentsPostAsyncWithHttpInfo($identifiant, $authorization, $content_type)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantDocumentsPostAsyncWithHttpInfo
     *
     * Envoyer des documents
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantDocumentsPost'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $content_type multipart/form-data; boundary&#x3D;-------------------------acebdf13572 (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantDocumentsPostRequest($identifiant, $authorization, $content_type)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantDocumentsPost'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantDocumentsPost'
            );
        }
        // verify the required parameter 'content_type' is set
        if ($content_type === null || (is_array($content_type) && count($content_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling apiIdentifiantDocumentsPost'
            );
        }
