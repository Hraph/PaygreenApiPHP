...
class GestionDesDocumentsKYCsApi
{
     ...
     */
    public function apiIdentifiantDocumentsGetRequest($identifiant, $authorization)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantDocumentsIdDeleteRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantDocumentsIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function apiIdentifiantDocumentsPostRequest($identifiant, $authorization, $content_type)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
