...
class RechercheApi
{
    ...
    /**
     * Operation apiIdentifiantPayinsSearchGet
     *
    ...
    {
        list($response) = $this->apiIdentifiantPayinsSearchGetWithHttpInfo($identifiant, $authorization);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayinsSearchGetWithHttpInfo
     *
     * Liste des transactions
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantPayinsSearchGetAsync
     *
     * Liste des transactions
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     */
    public function apiIdentifiantPayinsSearchGetAsync($identifiant, $authorization)
    {
        return $this->apiIdentifiantPayinsSearchGetAsyncWithHttpInfo($identifiant, $authorization)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsSearchGetAsyncWithHttpInfo
     *
     * Liste des transactions
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsSearchGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     *
     ...
     */
    protected function apiIdentifiantPayinsSearchGetRequest($identifiant, $authorization)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsSearchGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsSearchGet'
            );
        }

        $resourcePath = '/api/{identifiant}/payins/search';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiIdentifiantPayinsSearchIdGet
     *
     * Plus d'informations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    {
        list($response) = $this->apiIdentifiantPayinsSearchIdGetWithHttpInfo($identifiant, $authorization, $id);
        return $response;
    }

    /**
     * Operation apiIdentifiantPayinsSearchIdGetWithHttpInfo
     *
     * Plus d'informations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Operation apiIdentifiantPayinsSearchIdGetAsync
     *
     * Plus d'informations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiIdentifiantPayinsSearchIdGetAsync($identifiant, $authorization, $id)
    {
        return $this->apiIdentifiantPayinsSearchIdGetAsyncWithHttpInfo($identifiant, $authorization, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiIdentifiantPayinsSearchIdGetAsyncWithHttpInfo
     *
     * Plus d'informations
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
    ...
    /**
     * Create request for operation 'apiIdentifiantPayinsSearchIdGet'
     *
     * @param  string $identifiant Votre identifiant PayGreen (required)
     * @param  string $authorization Votre clé privée PayGreen (Bearer : votre-clé-privée) (required)
     * @param  string $id ID de la transaction (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsSearchIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $identifiant when calling apiIdentifiantPayinsSearchIdGet'
            );
        }
        // verify the required parameter 'authorization' is set
        if ($authorization === null || (is_array($authorization) && count($authorization) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $authorization when calling apiIdentifiantPayinsSearchIdGet'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiIdentifiantPayinsSearchIdGet'
            );
        }

        $resourcePath = '/api/{identifiant}/payins/search/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
