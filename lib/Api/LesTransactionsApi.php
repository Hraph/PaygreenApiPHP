...
class LesTransactionsApi
{
     ...
     */
    protected function apiIdentifiantPayinsTransactionCancelPostRequest($identifiant, $authorization, $id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionCashPostRequest($identifiant, $authorization, $payins)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionIdDeleteRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionIdGetRequest($identifiant, $authorization, $id)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionIdPatchRequest($identifiant, $authorization, $id, $patch_amount)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionIdPutRequest($identifiant, $authorization, $id, $execute_transaction)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionSubscriptionPostRequest($identifiant, $authorization, $payins_recc)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionTokenizePostRequest($identifiant, $authorization, $payins)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiIdentifiantPayinsTransactionXtimePostRequest($identifiant, $authorization, $payins_recc)
    {
        // verify the required parameter 'identifiant' is set
        if ($identifiant === null || (is_array($identifiant) && count($identifiant) === 0)) {
            throw new \InvalidArgumentException(
