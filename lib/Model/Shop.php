...
class Shop implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['available_mode'] = $data['available_mode'] ?? null;
        $this->container['business_identifier'] = $data['business_identifier'] ?? null;
        ...
        $this->container['paiement_type'] = $data['paiement_type'] ?? null;
        $this->container['with_vad'] = $data['with_vad'] ?? null;
        $this->container['without_vad'] = $data['without_vad'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['paiement_type']) && !in_array($this->container['paiement_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'paiement_type', must be one of '%s'",
                $this->container['paiement_type'],
