...
/**
 * PayinsBillingAddress Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 */
class PayinsBillingAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payins_billing_address';
     ...
     * Sets last_name
     *
     * @param string|null $lastName last_name
     *
     * @return $this
     */
     ...
     * Sets first_name
     *
     * @param string|null $firstName first_name
     *
     * @return $this
     */
     ...
     * Sets zipCode
     *
     * @param string|null $zipCode zip_code
     *
     * @return $this
     */
    public function setZipCode($zipCode)
    {
        $this->container['zip_code'] = $zipCode;
