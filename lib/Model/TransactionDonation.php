...
/**
 * TransactionDonation Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 ...
 */
class TransactionDonation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Transaction_donation';
     ...
     * Sets association_id
     *
     * @param int|null $association_id association_id
     *
     * @return self
     */
