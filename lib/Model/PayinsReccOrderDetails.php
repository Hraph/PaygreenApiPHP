...
/**
 * PayinsReccOrderDetails Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class PayinsReccOrderDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayinsRecc_orderDetails';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['first_amount'] = isset($data['first_amount']) ? $data['first_amount'] : null;
    }
    ...
    {
        return $this->container['first_amount'];
    }

    /**
     * Sets first_amount
     *
     * @param int|null $first_amount first_amount
     *
     * @return $this
     */
    public function setFirstAmount($first_amount)
    {
        $this->container['first_amount'] = $first_amount;
