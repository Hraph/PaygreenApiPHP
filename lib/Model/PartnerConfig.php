 ...
 * @link     https://openapi-generator.tech
 */
class PartnerConfig implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['available_payment_mode'] = isset($data['available_payment_mode']) ? $data['available_payment_mode'] : null;
        $this->container['iframe'] = isset($data['iframe']) ? $data['iframe'] : null;
        $this->container['is_limited'] = isset($data['is_limited']) ? $data['is_limited'] : null;
        $this->container['sold_available'] = isset($data['sold_available']) ? $data['sold_available'] : null;
    }
