...
/**
 * AuthAccessToken Class Doc Comment
 *
 * @category Class
 * @package  Hraph\PaygreenApi
 * @author   OpenAPI Generator team
 ...
 */
class AuthAccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthAccessToken';
    ...
    {
        $this->container['access_public'] = $data['access_public'] ?? null;
        $this->container['access_secret'] = $data['access_secret'] ?? null;
    ...
    {
        return $this->container['access_public'];
    }

    /**
     * Sets access_public
     *
     * @param string|null $access_public access_public
     *
     * @return self
     */
    public function setAccessPublic($access_public)
    {
        $this->container['access_public'] = $access_public;
