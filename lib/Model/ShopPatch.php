 ...
 */
class ShopPatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopPatch';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['validate'] === null) {
            $invalidProperties[] = "'validate' can't be null";
        }
