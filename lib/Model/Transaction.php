...
class Transaction implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_folder'] = isset($data['payment_folder']) ? $data['payment_folder'] : null;
        ...
        $this->container['value_at'] = isset($data['value_at']) ? $data['value_at'] : null;
        $this->container['answered_at'] = isset($data['answered_at']) ? $data['answered_at'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['value_at'] === null) {
            $invalidProperties[] = "'value_at' can't be null";
        }
    ...
    {
        return $this->container['payment_folder'];
    }

    /**
     * Sets payment_folder
     *
     * @param string|null $payment_folder payment_folder
     *
     * @return $this
     */
    public function setPaymentFolder($payment_folder)
    {
        $this->container['payment_folder'] = $payment_folder;
     ...
     * Sets url
     *
     * @param string|null $url Pour effectuer une transaction en utilisant le module Insite, il faut ajouter \"display=insite\" dans l'URL de paiement.
     *
     * @return $this
     */
     ...
     * Gets buyer
     *
     * @return \Hraph\PaygreenApi\Model\TransactionBuyer|null
     */
     ...
     * Sets buyer
     *
     * @param \Hraph\PaygreenApi\Model\TransactionBuyer|null $buyer buyer
     *
     * @return $this
     */
     ...
     * Gets schedules
     *
     * @return \Hraph\PaygreenApi\Model\TransactionSchedules|null
     */
     ...
     * Sets schedules
     *
     * @param \Hraph\PaygreenApi\Model\TransactionSchedules|null $schedules schedules
     *
     * @return $this
     */
     ...
     * Gets donation
     *
     * @return \Hraph\PaygreenApi\Model\TransactionDonation|null
     */
     ...
     * Sets donation
     *
     * @param \Hraph\PaygreenApi\Model\TransactionDonation|null $donation donation
     *
     * @return $this
     */
     ...
     * Sets value_at
     *
     * @param \DateTime $value_at value_at
     *
     * @return $this
     */
