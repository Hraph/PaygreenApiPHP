...
class InlineResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'code' => 'int',
        'data' => '\Hraph\PaygreenApi\Model\AuthAccessToken'
    ];
     ...
     * Gets data
     *
     * @return \Hraph\PaygreenApi\Model\AuthAccessToken|null
     */
     ...
     * Sets data
     *
     * @param \Hraph\PaygreenApi\Model\AuthAccessToken|null $data data
     *
     * @return self
     */
