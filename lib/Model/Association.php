...
class Association implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['descriptif'] = isset($data['descriptif']) ? $data['descriptif'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['descriptif'] === null) {
            $invalidProperties[] = "'descriptif' can't be null";
        }
    ...
    {
        return $this->container['descriptif'];
    }

    /**
     * Sets descriptif
     *
     * @param string $descriptif descriptif
     *
     * @return $this
     */
    public function setDescriptif($descriptif)
    {
        $this->container['descriptif'] = $descriptif;
