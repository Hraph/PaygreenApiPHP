 ...
 * @link     https://openapi-generator.tech
 */
class PayinsRecc implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayinsRecc';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['with_payment_link'] = isset($data['with_payment_link']) ? $data['with_payment_link'] : null;
        $this->container['emails'] = isset($data['emails']) ? $data['emails'] : null;
        $this->container['content_mail'] = isset($data['content_mail']) ? $data['content_mail'] : null;
